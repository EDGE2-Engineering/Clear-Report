...
export const cognitoAuth = {
    ...
    getSession(auth) {
        ...
        return {
            user: {
                ...
                // For now, defaulting to 'standard' - this needs to be configured in Cognito
    ...
    signOut(clientId, logoutUri, cognitoDomain) {
        ...
        window.location.href = `${cognitoDomain}/logout?client_id=${clientId}&logout_uri=${encodedLogoutUri}`;
    },
};
