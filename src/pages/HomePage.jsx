...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>EDGE2 MTR | Pure & Organic Products</title>
        <meta name="description" content="Shop for premium organic Ghee, Honey, Oils and more from EDGE2 MTR. 100% pure and chemical-free." />
      </Helmet>
